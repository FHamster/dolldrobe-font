    ...
    <el-container>
        ...
        <el-main>
            ...
            <el-main style="height: 560px ; display: flex; justify-content: center; flex-wrap: wrap">
                ...
                <el-main style="height: 490px;width: 1200px;display: flex; justify-content: center;">
                    <el-carousel arrow="never" height="360px" indicator-position="outside"
                                 style="width: 1140px;justify-content: center" :interval="4000">
            ...
            <el-main
                    style="height: 700px ; display: flex; justify-content: center; flex-wrap: wrap; background-color: #e2cdb1">
                <el-header height="30px" style="width: 1100px">
